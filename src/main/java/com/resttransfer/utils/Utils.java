package com.resttransfer.utils;
...
public class Utils {
    ...
    public static BigDecimal getBigDecimalScale2Down(final String money){
    ...
    static {
        String configFileName = System.getProperty("main.properties");

        if (configFileName == null) {
            configFileName = "main.properties";
        }
